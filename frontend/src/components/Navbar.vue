<template>
  ...
  <nav class="mt-10">
    ...
    <a
      ...
      href="/#"
      @click.prevent="changeNavBarItem('dashboard')"
    >
      <svg
        class="h-6 w-6"
    ...
    <a
      class="flex items-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100"
      href="/#"
      @click.prevent="changeNavBarItem('deploy')"
    >
      <svg
        class="h-6 w-6"
        xmlns="http://www.w3.org/2000/svg"
    ...
    <a
      class="flex items-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100"
      href="#"
      @click.prevent="changeNavBarItem('virtualmachines')"
    >
      <svg
        class="h-6 w-6"
        xmlns="http://www.w3.org/2000/svg"
    ...
    <a
      class="flex items-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100"
      href="#"
      @click.prevent="changeNavBarItem('volumes')"
    >
      <svg
        class="h-6 w-6"
        xmlns="http://www.w3.org/2000/svg"
    ...
    <a
      class="flex items-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100"
      href="/#"
      @click.prevent="changeNavBarItem('images')"
    >
      <svg
        class="h-6 w-6"
        xmlns="http://www.w3.org/2000/svg"
    ...
    <a
      class="flex items-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100"
      href="/#"
      @click.prevent="changeNavBarItem('connect')"
    >
      <svg
        class="h-6 w-6"
        xmlns="http://www.w3.org/2000/svg"
