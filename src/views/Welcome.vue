    ...
    <section class="min-h-screen flex items-stretch text-white ">
        <div class="lg:flex w-1/2 hidden bg-gray-500 bg-no-repeat bg-cover relative items-center">
            ...
            <div class="w-full px-24 z-10">
                <h1 class="text-5xl font-bold text-left tracking-wide">Keep it simple</h1>
                <p class="text-3xl my-4">Deploy your machines easily, we'll take of the process, you focus on working 😉</p>
            </div>
            <div class="bottom-0 absolute p-4 text-center right-0 left-0 flex justify-center space-x-4">
                <span>
                    <div class="w-12 h-12 rounded-full overflow-hidden border-2 dark:border-white border-gray-900">
                        <img src="/src/assests/images/fabio.jpeg" alt="" class="w-full h-full object-cover">
                    </div>
                </span>
                <span>
                    <div class="w-12 h-12 rounded-full overflow-hidden border-2 dark:border-white border-gray-900">
                        <img src="/src/assests/images/matias.png" alt="" class="w-full h-full object-cover">
                    </div>
                </span>
            </div>
        </div>
            ...
            <div class="w-full pxy-6 z-20 px-3">
                ...
                <form action="" class="sm:w-2/3 w-full px-4 lg:px-1 mx-auto">
                    ...
                    <div class="p-4 text-center right-0 left-0 flex justify-center space-x-4 mt-16 lg:hidden ">
                        <a href="#">
                            <img src="/src/assests/images/fabio.jpeg" alt="" class="rounded object-cover" width="50" height="50">
                        </a>
                        <a href="#">
                            <img src="/src/assests/images/matias.png" alt="" class="rounded object-cover" width="57">
                        </a>
                    </div>
                </form>
                <br />
